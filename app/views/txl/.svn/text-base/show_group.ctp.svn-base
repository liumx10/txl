...
<header class="bar bar-nav">
  <div class="segmented-control" style="height:7%; ">
    <a class="control-item active" href="#item1mobile" id="control1mobile" onclick="checkout(1)">
        联系人
    </a>
    <a class="control-item" href="#item2mobile" id="control2mobile" onclick="checkout(2)">
        下属部门
    </a>
    <a class="control-item" href="#item2mobile" id="control3mobile" onclick="checkout(3)">
        返回上层    
    </a>
  </div>
</header>
